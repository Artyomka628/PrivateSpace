...
title Приложения
color 8f
cd C:\Progra~1\PrivateSpace\Apps
dir "C:\Progra~1\PrivateSpace\Apps" /a-d > nul 2> nul && echo Готово! || goto MainEmpty
:ShowFiles
color 9f
cls
echo.
...
:Back
cd..
if NOT %cd%==C:\Progra~1\PrivateSpace\Apps* goto CantBack
goto ShowFiles
:Teleport
echo Введите путь.
set/p "cho=%cd%\"
...
cls
echo.
echo Невозможно выйти за пределы папки C:\Progra~1\PrivateSpace\Apps
