...
dir "C:\Progra~1\PrivateSpace\Files" /a-d > nul 2> nul && echo Ready! || goto MainEmpty
:ShowFiles
color 9f
cls
echo.
...
cls
echo.
echo You cannot move outside C:\Progra~1\PrivateSpace\Files
...
cls
color 4f
echo The "My Files" folder is empty!
