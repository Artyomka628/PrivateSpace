...
dir "C:\Progra~1\PrivateSpace\Games" /a-d > nul 2> nul && echo Готово! || goto MainEmpty
:ShowFiles
color 9f
cls
echo.
...
echo Обязательно добавить расширение!
echo.
set/p "cho=%cd%\"
start %cd%\%cho% /max
goto ShowFiles
...
cls
echo.
echo Невозможно выйти за пределы папки C:\Progra~1\PrivateSpace\Games
